...
{
    public class DidYouKnowPageModel : PageModel
    {
        ...
        public DidYouKnowPageModel(INotyfService toastNotification, NewsService newsService)
        {
        ...
        public void OnGet()
        {
            try
            {
                ...
                AllNews = NewsCatalogue.GetAllNewsOfType(NewsType.InfoNews);
                if (AllNews.Count > 0)
